...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/assetic/config'), false)));
    ...
    {
        require_once 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/jms_diextra/doctrine/EntityManager.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_8ec03beda71eadd6d14b13002b62480c');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_8ec03beda71eadd6d14b13002b62480c');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_8ec03beda71eadd6d14b13002b62480c');
        ...
        $d->setProxyDir('F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EM50705a8f8e480_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('F:/xampp/htdocs/Symfony212/Smfony21/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $a = $this->get('security.context');
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'F:/xampp/htdocs/Symfony212/Smfony21/app/../web', false);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod',
            ...
            'session.save_path' => 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/sessions',
            ...
            'router.resource' => 'F:/xampp/htdocs/Symfony212/Smfony21/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/jms_diextra/doctrine/EntityManager.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EM50705a8f8e480_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'F:/xampp/htdocs/Symfony212/Smfony21/app/cache/prod/jms_security',
